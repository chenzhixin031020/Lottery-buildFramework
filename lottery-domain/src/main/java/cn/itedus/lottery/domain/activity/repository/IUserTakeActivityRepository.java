...
public interface IUserTakeActivityRepository {
     ...
     * @param takeId            领取ID
     */
    void takeActivity(Long activityId, String activityName, Long strategyId, Integer state, Integer takeCount, Integer userTakeLeftCount, String uId, Date takeDate, Long takeId);
