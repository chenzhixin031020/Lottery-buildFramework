...
public class UserTakeActivityRepository implements IUserTakeActivityRepository {
    ...
    public int subtractionLeftCount(Long activityId, String activityName, Integer takeCount, Integer userTakeLeftCount, String uId) {
        if (takeCount == userTakeLeftCount) {
    ...
    @Override
    public void takeActivity(Long activityId, String activityName, Long strategyId, Integer state, Integer takeCount, Integer userTakeLeftCount, String uId, Date takeDate, Long takeId) {
    ...
    public void saveUserStrategyExport(DrawOrderVO drawOrder) {
        ...
        userStrategyExport.setMqState(Constants.MQState.INIT.getCode());//修改点
